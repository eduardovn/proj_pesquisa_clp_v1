...
@Entity
@Table(name = "peca_metalica_3")
public class PecaMetalica3 {
    @Id
    ...
    @Column(name = "peca3_status")
    private Boolean status;

    public PecaMetalica3() {
    }

    public PecaMetalica3(LocalDate dataFabricacao, Integer idContagem, String tipo, String descricao, LocalTime tempoCiclo, Boolean status) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PecaMetalica3 that)) return false;
    ...
    public String toString() {
        return "PecaMetalica3 [" + "id=" + id + ", dataFabricacao=" + dataFabricacao +
