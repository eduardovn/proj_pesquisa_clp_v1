...
@Entity
@Table(name = "peca_metalica_2")
public class PecaMetalica2 {
    @Id
    ...
    @Column(name = "peca2_status")
    private Boolean status;

    public PecaMetalica2() {
    }

    public PecaMetalica2(LocalDate dataFabricacao, Integer idContagem, String tipo, String descricao, LocalTime tempoCiclo, Boolean status) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PecaMetalica2 that)) return false;
    ...
    public String toString() {
        return "PecaMetalica2 [" + "id=" + id + ", dataFabricacao=" + dataFabricacao +
